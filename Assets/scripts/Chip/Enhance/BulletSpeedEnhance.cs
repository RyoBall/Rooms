...
public class BulletSpeedEnhance : EnhanceChipBase
{
    public override void chipentereffect(ChipBase chip)
    {
        ...
        {
            chip.gameObject.GetComponent<shooter>().attackfactor = chip.gameObject.GetComponent<shooter>().speedfactor += 0.2f;
        }
    }
